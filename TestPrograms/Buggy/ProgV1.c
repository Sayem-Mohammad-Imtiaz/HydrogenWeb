...
; <label>:15:                                     ; preds = %0
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i32 0, i32 0), double %17, double %19, double %21, double %23, double %25), !dbg !36
  br label %40, !dbg !36
...
; <label>:27:                                     ; preds = %0
  ...
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i32 0, i32 0), double %29, double %31, double %33, double %35, double %38), !dbg !43
  br label %40
...
!1 = !DIFile(filename: "Prog.c", directory: "/hydrogen/TestPrograms/Buggy")
!2 = !{}
...
!31 = !DILocation(line: 7, column: 70, scope: !28)
!32 = !DILocation(line: 7, column: 73, scope: !28)
!33 = !DILocation(line: 7, column: 76, scope: !28)
!34 = !DILocation(line: 7, column: 79, scope: !28)
!35 = !DILocation(line: 7, column: 82, scope: !28)
!36 = !DILocation(line: 7, column: 5, scope: !28)
!37 = !DILocation(line: 9, column: 70, scope: !28)
!38 = !DILocation(line: 9, column: 73, scope: !28)
!39 = !DILocation(line: 9, column: 76, scope: !28)
!40 = !DILocation(line: 9, column: 79, scope: !28)
!41 = !DILocation(line: 9, column: 83, scope: !28)
!42 = !DILocation(line: 9, column: 82, scope: !28)
